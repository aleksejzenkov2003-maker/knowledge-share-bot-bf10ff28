...
export const PII_PATTERNS: PiiPatternConfig[] = [
...

  {
    ...
    patterns: [
      ...
      // Фамилия И.О.: Иванов И.И. или Иванов И. И. (учитываем латинские буквы из PDF)
      /[А-ЯЁA-Z][а-яё]{2,20}[\s\u00A0]+[А-ЯЁA-Z]\.[\s\u00A0]?[А-ЯЁA-Z]\./g,
      // И.О. Фамилия: И.И. Иванов или И. И. Иванов (учитываем латинские буквы из PDF)
      /[А-ЯЁA-Z]\.[\s\u00A0]?[А-ЯЁA-Z]\.[\s\u00A0]+[А-ЯЁA-Z][а-яё]{2,20}/g,
    ],
    priority: 35,
    enabled: true,
    description: 'ФИО',
