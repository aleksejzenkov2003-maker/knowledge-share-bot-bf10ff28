...
export const PII_PATTERNS: PiiPatternConfig[] = [
  ...
  
  {
    ...
    token_prefix: 'PERSON',
    patterns: [
      // Полное ФИО именительный падеж (Иванов Иван Иванович)
      /[А-ЯЁ][а-яё]{2,15}\s+[А-ЯЁ][а-яё]{2,12}\s+[А-ЯЁ][а-яё]*(?:вич|вна|ич|ьич|евич|ович|евна|овна|ьевна|ьевич)\b/gi,
      // Родительный падеж ФИО (Иванова Ивана Ивановича, Петровой Анны Сергеевны)
      /[А-ЯЁ][а-яё]{2,15}(?:а|ой|евой|овой)\s+[А-ЯЁ][а-яё]{2,12}(?:а|ы|и|я)\s+[А-ЯЁ][а-яё]*(?:вича|вны|ича|евича|овича|евны|овны|ьевича|ьевны)\b/gi,
      // Творительный падеж ФИО (Ивановым Иваном Ивановичем)
      /[А-ЯЁ][а-яё]{2,15}(?:ым|ой|ем|ым)\s+[А-ЯЁ][а-яё]{2,12}(?:ом|ой|ем|ей)\s+[А-ЯЁ][а-яё]*(?:вичем|вной|ичем|евичем|овичем|евной|овной|ьевичем|ьевной)\b/gi,
      // Дательный падеж ФИО (Иванову Ивану Ивановичу)
      /[А-ЯЁ][а-яё]{2,15}(?:у|ой|ову|еву)\s+[А-ЯЁ][а-яё]{2,12}(?:у|е|ю)\s+[А-ЯЁ][а-яё]*(?:вичу|вне|ичу|евичу|овичу|евне|овне|ьевичу|ьевне)\b/gi,
      // Винительный падеж ФИО (Иванова Ивана Ивановича = как родительный для муж.)
      ...
      // Фамилия + Имя + Отчество через запятую (Ахмерова Рената Рашидовича, ...)
      /[А-ЯЁ][а-яё]{2,15}\s+[А-ЯЁ][а-яё]{2,12}\s+[А-ЯЁ][а-яё]*(?:вича|вны|ича|евича|овича|евны|овны)\s*,/gi,
    ],
