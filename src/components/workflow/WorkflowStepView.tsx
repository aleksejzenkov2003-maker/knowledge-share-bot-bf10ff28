    ...
    <div className="flex-1 flex flex-col min-h-0">
      ...
      {hasOutput ? (
        <Tabs defaultValue="chat" className="flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          {/* Chat tab — primary */}
          <TabsContent value="chat" className="flex-1 flex flex-col min-h-0 overflow-hidden px-4 pb-2 mt-0">
          ...
          {hasTwoDocs && (
            <>
              <TabsContent value="client_kp" className="flex-1 overflow-auto px-4 pb-4 mt-0">
              ...
              <TabsContent value="employee_report" className="flex-1 overflow-auto px-4 pb-4 mt-0">
                <WorkflowResultEditor
          ...
          {/* Single result tab */}
          {!hasTwoDocs && (
            <TabsContent value="result" className="flex-1 overflow-auto px-4 pb-4 mt-0">
              {userEdited && rawOut && (
          ...
          {/* JSON tab */}
          <TabsContent value="structured" className="flex-1 overflow-auto px-4 pb-4 mt-0">
          ...
          {/* Screenshots tab */}
          {screenshotArtifacts.length > 0 && (
            <TabsContent value="screenshots" className="flex-1 overflow-auto px-4 pb-4 mt-0">
