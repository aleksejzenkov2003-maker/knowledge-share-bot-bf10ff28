...
const providerModels: Record<string, { value: string; label: string }[]> = {
  ...
  openrouter: [
    ...
    { value: 'openai/gpt-5.2,anthropic/claude-sonnet-4.5,google/gemini-2.5-pro', label: '🛟 Fallback: GPT-5.2 → Claude 4.5 → Gemini 2.5 Pro' },
    { value: 'anthropic/claude-sonnet-4.5,openai/gpt-5.2', label: '🛟 Fallback: Claude 4.5 → GPT-5.2' },
