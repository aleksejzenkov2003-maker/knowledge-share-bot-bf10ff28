...
const providerModels: Record<string, { value: string; label: string }[]> = {
  ...
  openrouter: [
    { value: 'openrouter/auto', label: '🤖 Auto Router (NotDiamond выбирает модель)' },
    { value: 'openai/gpt-5.5,anthropic/claude-sonnet-4.6,google/gemini-3.1-pro-preview', label: '🛟 Fallback: GPT-5.5 → Claude 4.6 → Gemini 3.1 Pro' },
    { value: 'anthropic/claude-sonnet-4.6,openai/gpt-5.4', label: '🛟 Fallback: Claude 4.6 → GPT-5.4' },
    // OpenAI
    { value: 'openai/gpt-5.5', label: 'GPT-5.5 (флагман)' },
    ...
    // Anthropic
    { value: 'anthropic/claude-opus-4.7', label: 'Claude Opus 4.7 (топ)' },
    { value: 'anthropic/claude-opus-4.6', label: 'Claude Opus 4.6' },
    { value: 'anthropic/claude-sonnet-4.6', label: 'Claude Sonnet 4.6' },
    { value: 'anthropic/claude-sonnet-4.5', label: 'Claude Sonnet 4.5' },
    { value: 'anthropic/claude-haiku-4.5', label: 'Claude Haiku 4.5 (быстрый)' },
    // Google
    ...
    { value: 'qwen/qwen3-vl-235b-a22b-instruct', label: 'Qwen3 VL 235B Instruct' },
    { value: 'qwen/qwen3-coder', label: 'Qwen3 Coder 480B' },
    // Meta
