...
1. ✅ **Источники не сохраняются в Bitrix** - критический баг SSE буферизации исправлен
2. ✅ **Контекст теряется** - увеличен лимит с 30 до 50, добавлена агрегация вложений
3. ✅ **Диалог пропадает в Bitrix** - добавлена персистентность state через sessionStorage
4. ✅ **Ролевые ограничения** - добавлены allow_web_search и strict_rag_mode в chat_roles
